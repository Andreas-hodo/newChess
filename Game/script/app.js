...
class Rook extends Piece{
  ...
  createDirectionMoves(){  
    return this.cutDirection(this.createUpMoves()).concat(this.cutDirection(this.createDownMoves())).concat(this.cutDirection(this.createLeftMoves())).concat(this.cutDirection(this.createRightMoves()))
  }
  createUpMoves(){
    let moves = []
...
class Bishop extends Piece{
  ...
  createDirectionMoves(){  
    return this.cutDirection(this.createRightUpMoves()).concat(this.cutDirection(this.createLeftUpMoves())).concat(this.cutDirection(this.createRightDownMoves())).concat(this.cutDirection(this.createLeftDownMoves()))
  }
  createRightUpMoves(){
    let moves = []
...
class Pawn extends Piece{
  ...
  createDirectionMoves(){ 
    return this.cutDirection(this.moveForward()).concat(this.cutDiagonal(this.diagonalMove(1).toString())).concat(this.cutDiagonal(this.diagonalMove(-1).toString()))   
  }
  getDirection(color){
