...
class Pawn extends Piece{
  ...
  Promote(type){
    ...
    let createNewPiece = () =>{
      ...
      newPiece.src = "../images/white-rook.jpg"
      newPiece.id = "rook_15w"
      newPiece.classList.add("pieces","white")
      return newPiece
    }
    ...
    preparePiece()
    let piece = board.CreatePiece(pieceData.color,"rook_15w",pieceData.square,type,pieceData.x,pieceData.y)
    ...
    piece.drop({drag:newPiece,drop:targetSquare})
