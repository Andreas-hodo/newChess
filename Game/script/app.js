...
class Rook extends Piece{
  ...
  createMoves(){  
  return [this.createUpMoves(),this.createDownMoves(),this.createLeftMoves(),this.createRightMoves()].map(moves => this.cutDirection(moves)).flat();
  }
  createUpMoves(){
    let moves = []
...
class Knight extends Piece{
  ...
  createMoves(){  
    return this.cutMoves(this.createAllMoves())
  }
}
...
class Bishop extends Piece{
  ...
  createMoves(){ 
    return [this.createRightUpMoves(),this.createLeftUpMoves(),this.createRightDownMoves(),this.createLeftDownMoves()].map(moves => this.cutDirection(moves)).flat(); 
  }
  createRightUpMoves(){
    let moves = []
...
class Queen extends Piece{
  ...
  createMoves(){  
    let bishopmoves = new Bishop(this.getColor(),this.getName(),this.getSquare(),this.getType(),this.getX(),this.getY()).createMoves()
    let rookmoves = new Rook(this.getColor(),this.getName(),this.getSquare(),this.getType(),this.getX(),this.getY()).createMoves()
...
class Pawn extends Piece{
  ...
  createMoves(){
    return this.cutDirection(this.moveForward()).concat([this.diagonalMove(1),this.diagonalMove(-1).toString()].map(moves => this.cutDiagonal(moves.toString())).flat())   
  }
  getDirection(color){
