...
class Piece extends Board{
  ...
  drag(piece,additionaMoves = []){
    ...
    if(pieceobj.getType() == "king"){
      let castleMoves = pieceobj.Castle()
...
class King extends Piece{
  ...
  Castle(){
    ...
    let checkCastle = (empty,forcheck,rookId) =>{  
     ...
     if(canCastle){
      let castleData = {moves:forcheck[1],rook:transferRookSquare["g"],rookId}
      return castleData
     }
    return result 
   }
   ...
   return rook1.moves.concat(rook2.moves)
  }
