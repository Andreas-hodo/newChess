...
class Board extends Game{
 ...
 getstrFen(){
  ...
  flip(color){
    let boarwrapper = document.getElementById("chess_board_wrapper")
    boarwrapper.style.animation = `rotate-${color} 1s ease-in-out forwards`
  }
